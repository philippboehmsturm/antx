...
p={...
    ...
    'inf100'     '-------------------------------'                          '' ''
    'paramfile'     'elastixForward\TransformParameters.1.txt'    'relative path of mouse-specific transformationParameterfile(txt) e.g. "elastixForward\TransformParameters.1.txt" '      ''
