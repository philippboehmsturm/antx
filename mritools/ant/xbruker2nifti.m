...
if gui1==1
    ...
    msg={'BRUKER®-IMPORT',...
        ...
        '!!! Do not select a spezific single MouseFolder here !!!',...
        '    -use upper fields and lower left panel to navigate',...
        '    -select the "main"-BRUKER Folder from the right panel',...
        '    >>if the Bruker-path is visible in the lower panel, press [Done]'};
...
cm={'open folder  [1].[].shortcut', cc1
    ...
    'show ACQP  [4]', cc4 
    'show VOLUME  [5]', cc5};
id=selector2(d,dh,'iswait',1,'contextmenu',cm);
