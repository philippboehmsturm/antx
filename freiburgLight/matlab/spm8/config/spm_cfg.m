...
% $Id: spm_cfg.m 664 2012-01-18 08:51:41Z vglauche $
...
stats.values  = { spm_cfg_fmri_spec spm_cfg_fmri_design spm_cfg_fmri_data spm_cfg_factorial_design spm_cfg_fmri_est spm_cfg_con spm_cfg_results spm_cfg_regions spm_cfg_bms spm_cfg_ppi};
% ---------------------------------------------------------------------
% meeg preprocessing
% ---------------------------------------------------------------------
meegprep        = cfg_choice;
...
util.values  = { spm_cfg_disp spm_cfg_checkreg spm_cfg_check_reg_adv ...
                 spm_cfg_imcalc spm_cfg_reorient spm_cfg_voi spm_cfg_dicom spm_cfg_minc spm_cfg_ecat spm_cfg_spm_surf spm_cfg_cdir spm_cfg_md spm_cfg_movefile spm_cfg_deletefiles spm_cfg_defs spm_cfg_print spm_cfg_cat spm_cfg_exp_frames spm_cfg_get_orig_coord spm_cfg_plot_fdmar};
% ---------------------------------------------------------------------
% tools Tools
% ---------------------------------------------------------------------
tools         = cfg_choice;
