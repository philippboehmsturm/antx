...
% Guillaume Flandin
% $Id: spm_make_standalone.m 664 2012-01-18 08:51:41Z vglauche $
...
%==========================================================================
%-Sort out additional path names
%==========================================================================
if ispc
    afsroot = 'J:';
else
...
%    '-R','-singleCompThread',...
    '-a',spm('Dir'),...
    '-a',fullfile(afsroot,'.fbi.ukl.uni-freiburg.de','apps','mlib'),...
    '-a',fullfile(afsroot,'.fbi.ukl.uni-freiburg.de','apps','medphys'))
