...
% $Id: spm_ov_quiver3d.m 712 2010-06-30 14:20:19Z glauche $
...
switch cmd
  ...
  case 'redraw'
	...
	repmat([4*nmask+(1:nmask) 5*nmask+(1:nmask)],1,4)]';
	  ...
	  'Edgecolor', 'interp', 'FaceColor', 'interp','Parent',st.vols{volhandle}.ax{1}.ax);
	  ...
	  'Edgecolor', 'interp', 'FaceColor', 'interp','Parent',st.vols{volhandle}.ax{2}.ax); 
	  ...
	  'Edgecolor', 'interp', 'FaceColor', 'interp','Parent',st.vols{volhandle}.ax{3}.ax);
  ...
  case 'context_edit'
    ...
    spm_input('!DeleteInputObj',Finter);
    st.vols{volhandle}.quiver3d.(varargin{3}) = in;
    spm_orthviews('redraw');
