...
%
% @(#) $Id: spm_ov_dwprofile.m 712 2010-06-30 14:20:19Z glauche $
...
switch cmd
 ...
 case 'context_edit'
  ...
  switch varargin{3}
   case 'res'
    points=find(strncmp(cellstr(char(st.vols{volhandle}.dwprofile.voi)), ...
                   'point',5));
    planes=find(strncmp(cellstr(char(st.vols{volhandle}.dwprofile.voi)), ...
                   'plane',5));
    if ~isempty(points)
