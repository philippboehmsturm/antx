...
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.val{1}(1).sname = 'Branch: Respiratory (cfg_branch)';
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.val{1}(1).src_exbranch = substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1});
...
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.val{2}(1).sname = 'Branch: Pulse (cfg_branch)';
