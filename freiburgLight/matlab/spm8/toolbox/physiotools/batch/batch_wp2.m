...
matlabbatch{4}.menu_cfg.menu_struct.conf_branch.name = 'Pulse';
matlabbatch{4}.menu_cfg.menu_struct.conf_branch.tag = 'pulse';
...
matlabbatch{6}.menu_cfg.menu_struct.conf_branch.val{1}(1).sname = 'Branch: Pulse (cfg_branch)';
