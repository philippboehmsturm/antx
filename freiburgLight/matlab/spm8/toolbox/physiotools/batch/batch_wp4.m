...
matlabbatch{11}.menu_cfg.menu_struct.conf_branch.name = 'Cardiac+Respiratory';
matlabbatch{11}.menu_cfg.menu_struct.conf_branch.tag = 'cardresp';
...
matlabbatch{11}.menu_cfg.menu_struct.conf_branch.val{1}(1).sname = 'Branch: Cardiac (cfg_branch)';
matlabbatch{11}.menu_cfg.menu_struct.conf_branch.val{1}(1).src_exbranch = substruct('.','val', '{}',{9}, '.','val', '{}',{1}, '.','val', '{}',{1});
...
matlabbatch{11}.menu_cfg.menu_struct.conf_branch.val{2}(1).sname = 'Branch: Respiratory (cfg_branch)';
