...
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.name = 'Pulse';
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.tag = 'pulse';
...
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{1}(1).sname = 'Files: Data file (cfg_files)';
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{1}(1).src_exbranch = substruct('.','val', '{}',{5}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{1}(1).src_output = substruct('()',{1});
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{2}(1) = cfg_dep;
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{2}(1).tname = 'Val Item';
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{2}(1).tgt_spec = {};
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{2}(1).sname = 'Entry: Bandwidth (cfg_entry)';
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{2}(1).src_exbranch = substruct('.','val', '{}',{6}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{2}(1).src_output = substruct('()',{1});
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{3}(1) = cfg_dep;
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{3}(1).tname = 'Val Item';
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{3}(1).tgt_spec = {};
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{3}(1).sname = 'Menu: Flip sign of signal (cfg_menu)';
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{3}(1).src_exbranch = substruct('.','val', '{}',{7}, '.','val', '{}',{1}, '.','val', '{}',{1});
matlabbatch{8}.menu_cfg.menu_struct.conf_branch.val{3}(1).src_output = substruct('()',{1});
...
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.name = 'Respiratory';
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.tag = 'resp';
...
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.val{1}(1).sname = 'Branch: Pulse (cfg_branch)';
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.val{1}(1).src_exbranch = substruct('.','val', '{}',{8}, '.','val', '{}',{1}, '.','val', '{}',{1});
...
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.val{2}(1).sname = 'Branch: Respiratory (cfg_branch)';
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.val{2}(1).src_exbranch = substruct('.','val', '{}',{4}, '.','val', '{}',{1}, '.','val', '{}',{1});
...
matlabbatch{10}.menu_cfg.menu_struct.conf_branch.val{3}(1).sname = 'Menu: Correction type (cfg_menu)';
