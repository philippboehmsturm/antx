...
% 
% $Id: spm_defaults.m 647 2011-07-19 10:20:21Z vglauche $
...
defaults.images.format  = 'nii';  % used for DICOM, ECAT and MINC import

% DICOM Import defaults
%=======================================================================
defaults.dicom.root     = 'date_time'; % Folder hierarchy
